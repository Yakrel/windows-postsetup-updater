...
│
├── Ninite Chrome Installer.exe               # Unmanaged personal installer (Untouched)
├── Ninite Git IrfanView VLC...Installer.exe  # Unmanaged personal installer (Untouched)
├── directx_Jun2010_redist.exe                 # Legacy fixed package (Untouched)
└── Install League of Legends sg2.exe         # Unmanaged personal installer (Untouched)
```
